        ...
        Vast = function (player, settings) {
            ...
            return {
                ...
                timeupdate: function (e) {
                    ...
                    if (timeLeft > 0) {
                       // player.vast.skipButton.innerHTML = "Có thể đóng quảng cáo sau " + timeLeft + " giây";

                        var html = '<div style="font-size:12px;">Có thể đóng quảng cáo sau</div><div style="font-size:18px;">';
                        html = html + timeLeft + ' giây</div>';
                        player.vast.skipButton.innerHTML = html;
                    } else {
                        if ((' ' + player.vast.skipButton.className + ' ').indexOf(' enabled ') === -1) {
                            player.vast.skipButton.className += " enabled";
                            player.vast.skipButton.innerHTML = '<div style="font-size:18px;">Đóng quảng cáo</div>';
                        }
                    }
                }
            };
