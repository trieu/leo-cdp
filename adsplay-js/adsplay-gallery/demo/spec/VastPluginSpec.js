...
describe('videojs.vast plugin', function() {
  ...
  beforeEach(function() {
    ...
    (function() {
      ...
      if (/phantomjs/gi.test(window.navigator.userAgent)) {
        ...
        // see https://github.com/videojs/videojs-contrib-display-ad-test/blob/master/test/videojs.display-ad-test.test.js#L23
  ...
  describe("Requirements", function() {
    ...
    it("should bail out if player.display-ad-test isn't defined", function() {
      spyOn(console, "error");
  ...
  describe("Public methods", function() {
    ...
    describe("getContent", function() {
      ...
      describe("linear display-ad-test", function() {
        beforeEach(function() {
          spyOn(DMVAST.client, "get")
      ...
      describe("non-linear display-ad-test", function() {
        beforeEach(function() {
          spyOn(DMVAST.client, "get")
            .and.callFake(function(url, callback){
              var fake_response = {
        ...
        it("should do nothing with non-linear display-ad-test, and report the error", function() {
          player.vast({ url: 'balhbahblhab' });
