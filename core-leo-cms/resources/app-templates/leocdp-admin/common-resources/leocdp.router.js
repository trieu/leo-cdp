...
LeoCdpAdmin.navRouters = {
		...
		"Customer_Persona_List" : {
			...
			"breadcrumb" : ["Journey Map Data Hub", "Customer Persona List"]
		},
		"Customer_Persona_Report" : {
			"menuName" : "Customer Persona Report",
			"functionName" : "loadCustomerPersonaReport",
			"breadcrumb" : ["Journey Map Data Hub", "Customer Persona List", "Persona Report"]
		},
		"Customer_Persona_Editor" : {
			"menuName" : "Customer Persona Details",
			"functionName" : "loadCustomerPersonaDetails",
			"breadcrumb" : ["Journey Map Data Hub", "Customer Persona List", "Persona Editor"]
		},
		...
		"Media_Channel_List" : {
			...
			"breadcrumb" : ["Journey Map Data Hub", "Media Channel List"]
		},
		"Media_Channel_Report" : {
			"menuName" : "Media Channel Report",
			"functionName" : "loadMediaChannelReport",
			"breadcrumb" : ["Journey Map Data Hub", "Media Channel List" , "Media Channel Report" ]
		},
		"Media_Channel_Editor" : {
			"menuName" : "Media Channel Editor",
			"functionName" : "loadMediaChannelEditor",
			"breadcrumb" : ["Journey Map Data Hub", "Media Channel List" , "Media Channel Editor" ]
		},
		...
		"Customer_Touchpoint_List" : {
			...
			"breadcrumb" : ["Journey Map Data Hub", "Touchpoint List"]
		},
		"Customer_Touchpoint_Report" : {
			"menuName" : "Touchpoint Report",
			"functionName" : "loadCustomerTouchpointReport",
			"breadcrumb" : ["Journey Map Data Hub", "Customer Touchpoint List" , "Customer Touchpoint Report" ]
		},
		"Customer_Touchpoint_Editor" : {
			"menuName" : "Touchpoint Report",
			"functionName" : "loadCustomerTouchpointEditor",
			"breadcrumb" : ["Journey Map Data Hub", "Customer Touchpoint List" , "Customer Touchpoint Editor" ]
		},
		
		// 1.4 Journey Map List, Report and Editor
		"Customer_Journey_List" : {
			"menuName" : "Customer Journey List",
			"functionName" : "loadCustomerJourneyList",
			"breadcrumb" : ["Journey Map Data Hub", "Customer Journey List"]
		},
		"Journey_Map_Report" : {
			"menuName" : "Journey Map Report",
			"functionName" : "loadJourneyMapReport",
			"breadcrumb" : ["Journey Map Data Hub", "Customer Journey List", "Journey Map Report"]
		},
		"Journey_Map_Studio" : {
			"menuName" : "Journey Map Studio",
			"functionName" : "loadJourneyMapStudio",
			"breadcrumb" : ["Journey Map Data Hub", "Customer Journey List","Journey Map Studio"]
		},
		...
		"Data_Observer_List" : {
			...
			"breadcrumb" : ["Journey Map Data Hub", "Data Observer List"]
		},
		"Data_Observer_Report" : {
			"menuName" : "Data Observer Report",
			"functionName" : "loadDataObserverReport",
			"breadcrumb" : ["Journey Map Data Hub", "Data Observer List", "Data Observer Report"]
		},
		"Data_Observer_Configs" : {
			"menuName" : "Data Observer Configs",
			"functionName" : "loadDataObserverConfigs",
			"breadcrumb" : ["Journey Map Data Hub", "Data Observer List", "Data Observer Configs"]
		},
