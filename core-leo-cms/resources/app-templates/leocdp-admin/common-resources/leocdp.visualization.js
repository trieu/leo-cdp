...
var renderDonutChart = renderDonutChart || function(domSelector, data,totalCount, width, height, radius){
	    ...
	    g.append("text")
	        ...
	        _d[0] *= 1.38;	// multiply by a constant factor
	        _d[1] *= 1.38;	// multiply by a constant factor
	        return "translate(" + _d + ")";
	      })
	      .attr("dy", ".50em")
	      ...
	      .text(function(d) {
	        if(d.data.percentage == false || d.data.percentage < 8) {
	          return '';
	        }
