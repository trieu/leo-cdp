window.i18nLeoAdminData = window.i18nLeoAdminData || function () {
	...
	data["profile_full_name"] = "Tên khách hàng";
	data["profile_attributes"] = "Thuộc tính cá nhân";
	data["profile_expectations"] = "Nhu cầu và vấn đề của khách hàng"; 
	data["profile_interests"] = "Sở thích cá nhân và động lực hành động"; 
	data["profile_recommended_ideas"] = "Ý tưởng tiếp cận do hệ thống gợi ý"; 
	data["profile_recommended_solutions"] = "Sản phẩm và dịch vụ do hệ thống gợi ý"; 
	data["profile_touchpoints"] = "Các điểm đã tiếp xúc thông tin và trải nghiệm";
	data["profile_actions"] = "Những hành động của khách hàng";
