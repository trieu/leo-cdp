...
public class GenerateFakeEventData {
	...
	static {
		urls.add("https://bookstore.bigdatavietnam.org/html/page/data-science-books");
		urls.add("https://bookstore.bigdatavietnam.org/html/page/van-hoc-tac-pham-kinh-dien");
		urls.add("https://bookstore.bigdatavietnam.org/html/page/business-book");
		urls.add("https://bookstore.bigdatavietnam.org/html/page/artificial-intelligence-books");
		urls.add("https://bookstore.bigdatavietnam.org/html/page/programming-books");
		urls.add("https://bookstore.bigdatavietnam.org/html/page/basic-science-books");
	...
	static void generateEvents(Date loggedAt, String locationCode, String visitorId, String profileId, DeviceInfo deviceInfo, String userDeviceId, int profileType) {
		...
		Touchpoint refTouchPoint = TouchpointDataService.getOrCreateWebTouchpointForTesting(createdAt,
				touchpointRefDomain, MediaChannelType.WEB_URL, refTouchpointUrl, isFromOwnedMedia);
		...
		EventTrackingService.trackViewEvent(createdAt, ctxSession, observerId, "pro", userDeviceId, sourceIP,
		...
		for (int i = 0; i < randomPageviews; i++) {
			...
			// pageview event
			EventTrackingService.trackViewEvent(trackedTime, ctxSession, observerId, "pro", userDeviceId, sourceIP,
