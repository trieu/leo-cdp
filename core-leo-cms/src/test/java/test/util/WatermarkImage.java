...
public class WatermarkImage {
	...
	//BufferedImage warning = ImageIO.read(new URL("https://i-kinhdoanh.vnecdn.net/2018/11/09/n3-1541746749_r_680x0.jpg"));
	BufferedImage logo = ImageIO.read(new File("./public/images/leotech-logo.png"));
	BufferedImage robot = ImageIO.read(new URL("http://sciencenordic.com/sites/default/files/imagecache/620x/nao_robot_laerer-2.jpg"));
	...
	testImage.withFont(plain).wrap(true).write(
		"Do you think ")
		.newLine();
