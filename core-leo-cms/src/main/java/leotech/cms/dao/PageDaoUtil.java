...
public class PageDaoUtil {
    ...
    private static final String AQL_FIND_KEY_AQL = Page.contentFindKeyAql(Page.COLLECTION_NAME);
	...
	List<Page> list = new ArangoDbQuery<Page>(db, AQL_GET_PAGES_BY_NETWORK, bindVars, Page.class).getResultsAsList();
	return list;
    }
