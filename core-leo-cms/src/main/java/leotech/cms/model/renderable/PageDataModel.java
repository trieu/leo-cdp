...
public class PageDataModel extends WebPageDataModel {

    private final List<Page> pages;

    public PageDataModel(String host, String templateFolder, String templateName, String pageTitle, List<Page> pages) {
