...
public class User implements PersistentArangoObject {
    ...
    /**
     * access public, protected and private content, can create content in network
     */
	...
	return StringUtil.isNotEmpty(userEmail) && StringUtil.isNotEmpty(userLogin) && StringUtil.isNotEmpty(userPass) && StringUtil.isNotEmpty(this.displayName);
    }
