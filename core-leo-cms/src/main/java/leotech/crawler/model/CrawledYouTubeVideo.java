...
public class CrawledYouTubeVideo implements Comparable<CrawledYouTubeVideo>, PersistentArangoObject {
	...
	public CrawledYouTubeVideo(String videoID, String title, String description, long publishedAt,
			String thumbnailUrl, String url, String channelId, String channelTitle) {
		super();
	...
	public ArangoCollection getCollection() {
		if (collectionInstance == null) {
			...
			collectionInstance.ensurePersistentIndex(Arrays.asList("videoID"),
