...
public class YouTubeContentBot extends ContentBot {
    ...
    public static void doCrawlingByKeywordAndSaveDb(String keyword, int maxResultsPerQuery, int totalResults, String channelId) {
	List<CrawledYouTubeVideo> results = YouTubeVideoCrawler.query(keyword, maxResultsPerQuery, totalResults, channelId);
