...
/**
 * the utility class for Handlebars.java template (See more at
...
public class HandlebarsTemplateUtil {
	...
	handlebars.registerHelperMissing(new Helper<Object>() {
		...
		System.err.println(
			field + " is (NULL value) or (NOT existed) or (not found public getter) at " + tpl.filename());
    ...
    public static String process(String tplPath, Object model, String errorMessageIfNotFound) {
	if (tplPath == null) {
