...
public class CdpDataObserverHandler extends BaseSecuredDataApi {
	
	// for dataList view
	static final String API_LIST_ALL = "/cdp/dataobservers";
	static final String API_LIST_WITH_FILTER = "/cdp/dataobservers/filter";
	
	// for dataList view
	static final String API_CREATE_NEW = "/cdp/dataobserver/new";
	static final String API_UPDATE_MODEL = "/cdp/dataobserver/update";
	static final String API_GET_MODEL = "/cdp/dataobserver/get";
	static final String API_REMOVE = "/cdp/dataobserver/remove";
