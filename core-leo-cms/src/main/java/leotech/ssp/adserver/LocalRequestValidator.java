...
public class LocalRequestValidator {
    /**
     * Extracts and validates the request parameters.
     * 
     * @param request
     * @throws RequestException
     *             if params are mandatory and empty and cannot be replaced by an
     *             alternative value.
	...
	// Neither the "ParamValue" - object nor the list of params may fit to your
    ...
    private static String checkValue(final String toCheck, final ERROR_CODE code, final String message)
	    throws RequestException {
