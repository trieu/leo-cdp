...
public abstract class BaseSecuredDataApi extends BaseApiHandler {
	...
	public static final JsonDataPayload WRONG_USER_LOGIN = JsonDataPayload.fail("Wrong userLogin or password", 502);
	public static final JsonDataPayload USER_SESSION_BAD_FORMAT = JsonDataPayload.fail("usersession is bad format", 503);
    ...
    // (2)
    private static JsonDataPayload checkLoginHandler(String uri, String userSession, String userlogin, String userpass, String usersession) {
	if (isValidUserSession(usersession)) {
