...
/*
 * VMAP at https://github.com/dailymotion/vmap-js
 */
var VMAP = (function () {
    "use strict";
    var t = function (t, e) {
      ...
      a = function e(n) {
        for (var a in (t(this, e),
            (this.id = n.getAttribute("id")),
            (this.allowMultipleAds = n.getAttribute("allowMultipleAds")),
            (this.followRedirects = n.getAttribute("followRedirects")),
          ...
          switch (r.localName) {
            ...
            case "VASTAdData":
              for (
                this.vastAdData = r.firstChild; this.vastAdData && 1 !== this.vastAdData.nodeType;
    ...
    function i(t) {
      ...
      return (
        ...
        t.attributes && [].concat(n(t.attributes)).forEach(function (t) {
          t.nodeName &&
            void 0 !== t.nodeValue &&
            null !== t.nodeValue &&
            (e.attributes[t.nodeName] = t.nodeValue);
        }),
        t.childNodes && []
        .concat(n(t.childNodes))
        .filter(function (t) {
        ...
        e(n, [{
            ...
            value: function (t, e) {
              for (var n in this.trackingEvents) {
                ...
                if (a.event === t) {
                  var r = a.uri;
                  "error" === a.event && (r = r.replace("[ERRORCODE]", e)),
                    this.tracker(r);
                }
              }
            }
    ...
    return function e(n) {
      if (
        (t(this, e),
          null == (null != n ? n.documentElement : void 0) ||
          "VMAP" !== n.documentElement.localName)
      )
        throw new Error("Not a VMAP document");
      for (var a in ((this.version = n.documentElement.getAttribute("version")),
          (this.adBreaks = []),
          (this.extensions = []),
          n.documentElement.childNodes)) {
