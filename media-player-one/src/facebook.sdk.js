/*1546409958,,JIT Construction: v4658916,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("ES7ArrayPrototype", ["ES5Array", "ES5ArrayPrototype"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    a = {
                        includes: function (a) {
                            "use strict";
                            __p && __p();
                            if (a !== void 0 && i(this) && !(typeof a === "number" && isNaN(a))) return j.apply(this, arguments) !== -1;
                            var b = Object(this),
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/j-GHT1gpo6-.js?version=43",
                    "useCdn": true
                });
                __d("JSSDKCssConfig", [], {
                ...
                __d("ManagedError", [], (function (a, b, c, d, e, f) {
                    ...
                    function a(a, b) {
                        "use strict";
                        g.constructor.call(this, a !== null && a !== void 0 ? a : ""), a !== null && a !== void 0 ? this.message = a : this.message = "", this.innerError = b
                    }
                    e.exports = a
                }), null);
                ...
                __d("insertIframe", ["GlobalCallback", "getBlankIframeSrc", "guid"], (function (a, b, c, d, e, f, g, h, i) {
                    ...
                    function a(a) {
                        ...
                        if (document.attachEvent) {
                            ...
                            a.height !== void 0 && (e.style.height = a.height + "px");
                            a.width !== void 0 && (a.width == "100%" ? e.style.width = a.width : e.style.width = a.width + "px");
                ...
                __d("Queue", [], (function (a, b, c, d, e, f) {
                    ...
                    h.prototype._dispatch = function (a) {
                        ...
                        if (b != null) a.call(this, this._queue.shift()), this._timeout = setTimeout(ES(function () {
                ...
                __d("XDM", ["DOMWrapper", "Log", "UserAgent_DEPRECATED", "emptyFunction", "guid", "sdk.DOMEventListener", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    var n = {},
                        o = {
                            transports: []
                    ...
                    a = {
                        register: function (a, b) {
                            h.debug("Registering %s as XDM provider", a), o.transports.push(a), n[a] = b
                        },
                        create: function (a) {
                            __p && __p();
                            ...
                            a.channel || (h.warn("Missing channel name, selecting at random"), a.channel = k());
                            a.whenReady || (a.whenReady = j);
                            a.onMessage || (a.onMessage = j);
                            b = (b = a.transport) != null ? b : q(a.blacklist || []);
                            var c = b != null ? n[b] : null;
                    ...
                    a.register("postmessage", function () {
                        ...
                        return {
                            ...
                            init: function (b) {
                                ...
                                var c = "_FB_" + b.channel,
                                    d = {
                                        send: function (a, b, c, d) {
                                            if (p === c) {
                                                h.error("Invalid windowref, equal to window (self)");
                                                throw new Error()
                                            }
                                            ...
                                            i.ie() == 8 || i.ieCompatibilityMode() ? p.setTimeout(e, 0) : e()
                                        }
                                    };
                                if (a) {
                                    b.whenReady(d);
                                ...
                                l.add(p, "message", m(function (a) {
                                    __p && __p();
                                    var d = a.data,
                                        e = a.origin || "native";
                                    if (!/^(https?:\/\/|native$)/.test(e)) {
                                        h.debug("Received message from invalid origin type: %s", e);
                                        return
                                    }
                                    if (e !== "native" && !(r.test(location.hostname) || r.test(a.origin))) return;
                                    if (typeof d !== "string") {
                                        h.warn("Received message of type %s from %s, expected a string", typeof d, e);
                                        return
                                    }
                                    h.debug("received message %s from %s", d, e);
                ...
                __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "XDM", "guid", "isFacebookURI", "sdk.Content", "sdk.createIframe", "sdk.Event", "sdk.feature", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    function K(a, b) {
                        ...
                        switch (a.xd_action) {
                            case "proxy_ready":
                                ...
                                a.registered && (J(a.registered), w = c.merge(w, !1));
                                h.info("Proxy ready, starting queue containing %s messages", c.getLength());
                                c.start(function (a) {
                                    a != null && typeof a === "object" && (a = i.encode(a)), D.send(a, b, d.contentWindow, B + "_" + z)
                                });
                                break;
                            case "plugin_ready":
                                if (typeof a.name === "string") {
                                    c = a.name;
                                    h.info("Plugin %s ready, protocol: %s", c, z);
                                    H[c] = {
                                        protocol: z
                                    };
                                    if (j.exists(c)) {
                                        var e = j.get(c, {});
                                        h.debug("Enqueuing %s messages for %s in %s", e.getLength(), c, z + "ProxyQueue");
                                        x.merge(e, !1)
                                    }
                                } else h.error("plugin_ready message received without a name");
                                break
                        }
                        a.data && L(a.data, b)
                    }
                    ...
                    function L(a, b) {
                        __p && __p();
                        if (b != null && b !== "native" && !n(new v(b))) return;
                        if (typeof a === "string") {
                            if (/^FB_RPC:/.test(a)) {
                        ...
                        a = a;
                        b == null && (a.xd_sig === y && (b = a.xd_origin));
                        if (a.xd_action) {
                            K(a, b);
                            return
                        }
                    ...
                    function M(a, b) {
                        if (a == "facebook") typeof b === "object" && (b.relation = "parent.parent"), w.enqueue(b);
                        else {
                            typeof b === "object" && (b.relation = 'parent.frames["' + a + '"]');
                            var c = H[a];
                ...
                __d("sdk.Auth", ["DOMWrapper", "Log", "OAuthControllerParameterName", "ObservableMixin", "QueryString", "UrlMap", "guid", "sdk.Cookie", "sdk.createIframe", "sdk.feature", "sdk.getContextType", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.URI", "sdk.WebStorage", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x) {
                    __p && __p();
                    var y = "fblst_",
                        z = "fblo_",
                        A = 365 * 24 * 60 * 60 * 1e3,
                    ...
                    function E(a, b) {
                        ...
                        (g || c) && D.inform("logout", d);
                        (f || c) && D.inform("login", d);
                        h && D.inform("authresponse.change", d);
                        e && D.inform("status.change", d);
                        return d
                    }
                        ...
                        return function (d) {
                            ...
                            if (d && d.access_token) {
                                ...
                                if (s.getUseLocalStorage() && location.protocol === "https:" && d.long_lived_token) {
                                    f = w.getLocalStorage();
                                    f && f.setItem(y + s.getClientID(), d.long_lived_token)
                                }
                                if (s.getUseCookie()) {
                                ...
                                g = "connected";
                                E(b, g)
                            } else c === "logout" || c === "login_status" ? (d && d.error === "not_authorized" ? (g = "not_authorized", E(null, g)) : d && d.error === "authorization_expired" ? (g = "authorization_expired", E(null, g)) : (g = "unknown", E(null, g)), s.getUseCookie() && n.clearSignedRequestCookie(), s.getUseLocalStorage() && H(), c === "logout" && (J(), t.log("jssdk_error", {
                                appId: s.getClientID(),
                            ...
                            }))) : d && d.error === "access_denied" && (J(), g = "unknown", E(null, g));
                            if (a) {
                                f = {
                                    authResponse: b,
                    ...
                    function H() {
                        var a = w.getLocalStorage();
                        a && a.removeItem(y + s.getClientID())
                    }
                    ...
                    function J() {
                        n.setRaw(z, "y", ES("Date", "now", !1) + A, !1)
                    }
                    ...
                    function K(a) {
                        ...
                        var d = n.getRaw(z) === "y",
                            e = null,
                            f = !1;
                        if (/^https?:\/\/([\w\.]+)?facebook.com\//.test(document.referrer)) {
                            ...
                            j = k.decode(location.search);
                            j.error === "access_denied" && (f = !0)
                        }
                        if (d || f) {
                            j = "unknown";
                            E(null, j);
                        ...
                        var t = G(a, B, "login_status");
                        d = new v(l.resolve("www") + "/connect/ping").addQueryData(i.CLIENT_ID, s.getClientID()).addQueryData(i.RESPONSE_TYPE, "token,signed_request").addQueryData(i.DOMAIN, location.hostname).addQueryData(i.ORIGIN, q()).addQueryData(i.REDIRECT_URI, x.handler(function (a) {
                            ...
                            t(a) && (C = window.setTimeout(function () {
                                K(function () {})
                            }, 12e5))
                        ...
                        if (window.location.ancestorOrigins) {
                            ...
                            if (f.length > 0) {
                                j = "";
                                for (var a = 0; a < f.length; a++) j += f[a], j += ",";
                                d.addQueryData(i.ANCESTOR_ORIGINS, j.slice(0, -1))
                            }
                        }
                        f = w.getLocalStorageForRead();
                        if (f) {
                            a = f.getItem(y + s.getClientID());
                            a && d.addQueryData(i.EXPLICIT_TOKEN, a)
                        }
                        e != null && d.addQueryData(i.EXPLICIT_TOKEN, e);
                        b = o({
                            root: g.getRoot(),
                            name: m(),
                            url: d.toString(),
                    ...
                    function a(a, b) {
                        ...
                        if (a)
                            if (!b && L === "loaded") {
                                ...
                                a(c);
                                return
                            } else D.subscribe("FB.loginStatus", a);
                        if (!b && L === "loading") return;
                        L = "loading";
                        c = function (a) {
                            L = "loaded", D.inform("FB.loginStatus", a), D.clearSubscribers("FB.loginStatus")
                        };
                        K(c)
                    }
                ...
                __d("sdk.unsecureDisallowed", ["Log", "sdk.feature", "sdk.Runtime", "sdk.Scribe"], (function (a, b, c, d, e, f, g, h, i, j) {
                    ...
                    function a(a) {
                        if (window.location.protocol !== "https:" && k && k - ES("Date", "now", !1) <= 0) {
                            g.log("error", -1, "The method FB.%s can no longer be called from http pages. %s", a, l);
                            return !0
                        }
                        window.location.protocol !== "https:" && k && (g.log("error", -1, "The method FB.%s will soon stop working when called from http pages. Please update your site to use https for Facebook Login. %s", a, l), h("https_only_scribe_logging", !0) && !Object.prototype.hasOwnProperty.call(m, a) && (j.log("jssdk_error", {
                            appId: i.getClientID(),
                            error: "HttpsOnly",
                            extra: {
                                message: a
                ...
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "FBAppEvents", "sdk.Auth", "sdk.Event", "sdk.Impressions", "sdk.Model", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    k.subscribe("init:post", function (a) {
                        n.getClientID() && (a.autoLogAppEvents !== void 0 && (h.isBoolean(a.autoLogAppEvents, "Type of property autoLogAppEvents must be boolean"), n.setAutoLogAppEvents(a.autoLogAppEvents)), n.getAutoLogAppEvents() && F(n.getClientID()))
                    });
                    e.exports = {
                        activateApp: b,
                        logEvent: D,
                    ...
                    a = {
                        ...
                        addIdleDesktopAction: function (a, b, c) {
                            ...
                            return i.add(a, "mouseenter", function () {
                                clearTimeout(d), e || (e = i.add(a, "mouseleave", function () {
                                    f()
                                }))
                            })
                        },
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Content", "sdk.Dialog", "sdk.DOM", "sdk.Event", "sdk.Extensions", "sdk.fbt", "sdk.feature", "sdk.Frictionless", "sdk.getContextType", "sdk.Native", "sdk.openMessenger", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E) {
                    ...
                    var F = {
                        transform: function (a) {
                            if (a.params.display === "touch" && M.canIframe(a.params) && window.postMessage) {
                                a.params.channel = M._xdChannelHandler(a.id, "parent");
                                D.nativeApp() || (a.params.in_iframe = 1);
                                return a
                            } else return M.genericTransform(a)
                        },
                        getXdRelation: function (a) {
                            var b = a.display;
                            return b === "touch" && window.postMessage && a.in_iframe ? "parent" : M.getXdRelation(a)
                        }
                    };
                    ...
                    function H(a) {
                        return G(a) && t.supportsDialog("oauth")
                    }

                    function I(a) {
                        return G(a) && (a.is_account_link === !0 || a.is_account_link === "true") && t.supportsDialog("accountLink")
                    }
                    a = {
                        "stream.share": {
                            size: {
                        ...
                        apprequests: {
                            transform: function (a) {
                                a = F.transform(a);
                                a.params.frictionless = w && w._useFrictionless;
                                a.params.frictionless && (w.isAllowed(a.params.to) && (a.params.display = "iframe", a.params.in_iframe = !0, a.hideLoader = !0), a.cb = w._processRequestResponse(a.cb, a.hideLoader));
                                a.closeIcon = !1;
                                return a
                            },
                        ...
                        "permissions.oauth": {
                            url: "dialog/oauth",
                            size: {
                                width: D.mobile() ? null : 600,
                                height: D.mobile() ? null : 679
                            },
                            transform: function (a) {
                                __p && __p();
                                if (!B.getClientID()) {
                                    g.error("FB.login() called before FB.init().");
                                    return
                                }
                                if (o.getAuthResponse() && !a.params.scope && !a.params.auth_type) {
                                    g.error("FB.login() called when user is already connected.");
                                    a.cb && a.cb({
                                        status: B.getLoginStatus(),
                                ...
                                var d = a.params.auth_type === "reauthenticate",
                                    e = ES("Object", "keys", !1, ES("Object", "assign", !1, a.params.response_type ? j(a.params.response_type.split(",")) : {}, {
                                        token: !0,
                                        signed_request: !0
                                    })).join(",");
                                a.params.display === "async" ? (ES("Object", "assign", !1, a.params, {
                                    client_id: B.getClientID(),
                                    origin: x(),
                                    response_type: e,
                                    domain: location.hostname
                                }), a.cb = o.xdResponseWrapper(b, o.getAuthResponse(), "permissions.oauth")) : (d && M._xdNextHandler(function (a) {
                                    b({
                                        authResponse: null,
                                    ...
                                    client_id: B.getClientID(),
                                    redirect_uri: n(M.xdHandler(b, c, "opener", o.getAuthResponse(), "permissions.oauth", !d)),
                                    origin: x(),
                                    response_type: e,
                                    domain: location.hostname
                                }));
                        ...
                        "auth.logout": {
                            url: "logout.php",
                            transform: function (a) {
                                if (!B.getClientID()) g.error("FB.logout() called before calling FB.init().");
                                else if (!o.getAuthResponse()) g.error("FB.logout() called without an access token.");
                                else {
                                    a.params.next = M.xdHandler(a.cb, a.id, "parent", o.getAuthResponse(), "logout", !0);
                                    return a
                                }
                            }
                        },
                        "login.status": {
                            ...
                            transform: function (a) {
                                ...
                                ES("Object", "assign", !1, a.params, {
                                    client_id: B.getClientID(),
                                    redirect_uri: M.xdHandler(b, c, "parent", o.getAuthResponse(), "login_status", !0),
                                    origin: x(),
                    ...
                    var M = {
                        ...
                        genericTransform: function (a) {
                            (a.params.display == "dialog" || a.params.display == "iframe") && ES("Object", "assign", !1, a.params, {
                                display: "iframe",
                                channel: M._xdChannelHandler(a.id, "parent.parent")
                            }, !0);
                            return a
                        },
                        checkOauthDisplay: function (a) {
                            var b = a.scope || a.perms || B.getScope();
                            return !b ? a.display : "popup"
                        },
                        prepareCall: function (a, b) {
                            __p && __p();
                            var c = a.method.toLowerCase(),
                                d = Object.prototype.hasOwnProperty.call(M.Methods, c) ? ES("Object", "assign", !1, {}, M.Methods[c]) : {},
                                e = l(),
                                f = !0;
                            ES("Object", "assign", !1, a, {
                                app_id: B.getClientID(),
                                locale: B.getLocale(),
                                sdk: "joey",
                                access_token: f && B.getAccessToken() || void 0
                            });
                            (c === "share" || c === "share_open_graph") && (a.mobile_iframe = D.mobile() && (a.mobile_iframe || a.iframe_test), a.mobile_iframe && (d = ES("Object", "assign", !1, {}, F)));
                            a.display = M.getDisplayMode(d, a);
                            d.url || (d.url = "dialog/" + c);
                            (d.url == "dialog/oauth" || d.url == "dialog/permissions.request") && (a.display == "iframe" || a.display == "touch" && a.in_iframe) && (a.display = M.checkOauthDisplay(a));
                            a.display == "popup" && !d.require_access_token && delete a.access_token;
                            B.getIsVersioned() && d.url.substring(0, 7) === "dialog/" && (d.url = a.version + "/" + d.url);
                            if (L(a)) {
                                if (J[c]) {
                            ...
                            f = {
                                cb: b,
                                id: e,
                                size: d.size || M.getDefaultSize(),
                                url: i.resolve(a.display == "touch" ? "m" : "www") + "/" + d.url,
                                params: a,
                                name: c,
                                dialog: q.newInstance(e, a.display)
                            };
                            b = d.transform ? d.transform : M.genericTransform;
                            if (b) {
                                f = b(f);
                                if (!f) return
                            }
                            a.display === "touch" && a.in_iframe && (f.params.parent_height = window.innerHeight);
                            c = d.getXdRelation || M.getXdRelation;
                            b = c(f.params);
                            !(f.id in M._defaultCb) && !("next" in f.params) && !("redirect_uri" in f.params) && (f.params.next = M._xdResult(f.cb, f.id, b, !0));
                            (b === "parent" || b === "opener") && ES("Object", "assign", !1, f.params, {
                                channel_url: M._xdChannelHandler(e, b === "parent" ? "parent.parent" : "opener")
                            }, !0);
                            f = M.prepareParams(f);
                            return f
                        },
                        prepareParams: function (a) {
                            ...
                            a.params.kid_directed_site = B.getKidDirectedSite() || a.params.kid_directed_site;
                            a.params = k(a.params);
                            var b = h.encode(a.params);
                            !D.nativeApp() && M.urlTooLongForIE(a.url + "?" + b) ? a.post = !0 : b && (a.url += "?" + b);
                            return a
                        },
                        urlTooLongForIE: function (a) {
                            return D.ie() && D.ie() <= 8 && a.length > 2048
                        },
                        getDisplayMode: function (a, b) {
                            __p && __p();
                            if (b.display === "hidden" || b.display === "none" || b.display === "native") return b.display;
                            var c = B.isEnvironment(B.ENVIRONMENTS.CANVAS) || B.isEnvironment(B.ENVIRONMENTS.PAGETAB);
                            if (c && !b.display) return "async";
                            if (H(b) || I(b)) return "async";
                            if (D.mobile() || b.display === "touch") return "touch";
                            if ((b.display == "iframe" || b.display == "dialog") && !M.canIframe(b)) {
                                g.error('"dialog" mode can only be used when the user is connected.');
                                return "popup"
                            }
                            return a.connectDisplay && !c ? a.connectDisplay : b.display || (M.canIframe(b) ? "dialog" : "popup")
                        },
                        canIframe: function (a) {
                            if (B.getAccessToken()) return !0;
                            return D.mobile() && B.getLoggedIntoFacebook() ? !!a.mobile_iframe : !1
                        },
                        getXdRelation: function (a) {
                            a = a.display;
                        ...
                        popup: function (a) {
                            ...
                            var b = window.screenX,
                                ...
                                f = D.mobile() ? null : a.size.width,
                                g = D.mobile() ? null : a.size.height;
                            ...
                            c.push("top=" + d);
                            c.push("scrollbars=1");
                            (a.name == "permissions.request" || a.name == "permissions.oauth") && (c.push("toolbar=0"), (!D.chrome() || D.chrome() < 59) && c.push("location=1"));
                            e = c.join(",");
                            a.post ? (f = window.open("about:blank", a.id, e), f && (M.setLoadedNode(a, f, "popup"), p.submitToTarget({
                                url: a.url,
                                target: a.id,
                                params: a.params
                            }))) : (f = window.open(a.url, a.id, e), f && M.setLoadedNode(a, f, "popup"));
                            if (!f) {
                                v("popup_blocker_scribe_logging", !0) && C.log("jssdk_error", {
                                    appId: B.getClientID(),
                            ...
                            a.id in M._defaultCb && M._popupMonitor()
                        },
                        ...
                        hidden: function (a) {
                            a.className = "FB_UI_Hidden", a.root = p.appendHidden(""), M._insertIframe(a)
                        },
                        iframe: function (a) {
                            __p && __p();
                            a.className = "FB_UI_Dialog";
                            a.params.mobile_iframe && (q.setForceTabletStyle(!0), q.setCloseOnOverlayTap(!0), q.setPositionDialogAtTopWhenPortrait(!0));
                            var b = function () {
                                    var b = ES("JSON", "stringify", !1, {
                                        error_code: 4201,
                                        error_message: u._("User canceled the Dialog flow")
                                    });
                                    M._triggerDefault(a.id, b)
                                },
                                c = {
                                    onClose: b,
                                    closeIcon: a.closeIcon === void 0 ? !0 : a.closeIcon,
                                    classes: q.isTabletStyle() ? "centered" : ""
                                };
                            a.params.mobile_iframe && (c.styles = {
                                "border-radius": "8px"
                            });
                            a.root = q.create(c);
                            a.hideLoader || q.showLoader(b, a.size.width);
                            r.addCss(a.root, "fb_dialog_iframe");
                            M._insertIframe(a)
                        },
                        touch: function (a) {
                            a.params && a.params.in_iframe ? a.ui_created ? q.showLoader(function () {
                                M._triggerDefault(a.id, null)
                            }, 0) : M.iframe(a) : D.nativeApp() && !a.ui_created ? (a.frame = a.id, y.onready(function () {
                                M.setLoadedNode(a, y.open(a.url + "#cb=" + a.frameName), "native")
                            }), M._popupMonitor()) : a.ui_created || M.popup(a)
                        },
                        async: function (a) {
                            __p && __p();
                            ...
                            H(a.params) || I(a.params) ? (a.params.method = "oauth", a.params.redirect_uri = a.params.next, t.remote.showDialog(a.params, b)) : A.remote.showDialog(a.params, b)
                        },
                        "native": function (a) {
                            z(a.params)
                        },
                        getDefaultSize: function () {
                            return q.getDefaultSize()
                        },
                        _insertIframe: function (a) {
                            M._loadedNodes[a.id] = !1;
                            var b = function (b) {
                                a.id in M._loadedNodes && M.setLoadedNode(a, b, "iframe")
                            };
                            a.post ? m({
                                url: "about:blank",
                                root: a.root,
                        ...
                        _handleResizeMessage: function (a, b) {
                            ...
                            E.inform("resize.ack", b || {}, "parent.frames[" + a.name + "]");
                            !q.isActive(a) ? q.show(a) : q._centerActive()
                        },
                        _triggerDefault: function (a, b) {
                            ...
                            b && (c.result = b);
                            M._xdRecv(c, M._defaultCb[a] || function () {})
                        },
                        _popupMonitor: function () {
                            __p && __p();
                            var a;
                            for (var b in M._loadedNodes)
                                if (Object.prototype.hasOwnProperty.call(M._loadedNodes, b) && b in M._defaultCb) {
                                    var c = M._loadedNodes[b];
                                    if (c.type != "popup" && c.type != "native") continue;
                                    c = c.node;
                                    try {
                                        c.closed ? M._triggerDefault(b, null) : a = !0
                                    } catch (a) {}
                                } a && !M._popupInterval ? M._popupInterval = setInterval(M._popupMonitor, 100) : !a && M._popupInterval && (clearInterval(M._popupInterval), M._popupInterval = null)
                        },
                        _xdChannelHandler: function (a, b) {
                            __p && __p();
                            return E.handler(function (b) {
                                __p && __p();
                                var c = M.getLoadedNode(a);
                                if (!c) return;
                                if (b.type == "resize") M._handleResizeMessage(a, b);
                                else if (b.type == "hide") q.hide(c);
                                else if (b.type == "rendered") {
                                    c = q._findRoot(c);
                                    q.show(c)
                                } else b.type == "fireevent" && s.fire(b.event, b)
                            }, b, !0, null)
                        },
                        ...
                        _xdRecv: function (a, b) {
                            __p && __p();
                            var c = M.getLoadedNode(a.frame);
                            if (c)
                                if (c.close) try {
                                    c.close(), /iPhone.*Version\/(5|6)/.test(navigator.userAgent) && RegExp.$1 !== "5" && window.focus(), M._popupCount--
                                } catch (a) {} else r.containsCss(c, "FB_UI_Hidden") ? setTimeout(function () {
                                    c.parentNode.parentNode.removeChild(c.parentNode)
                                }, 3e3) : r.containsCss(c, "FB_UI_Dialog") && q.remove(c);
                            delete M._loadedNodes[a.frame];
                            delete M._defaultCb[a.frame];
                            if (a.e2e) {
                                var d = q.get(a.frame);
                                d.trackEvents(a.e2e);
                                d.trackEvent("close");
                        ...
                        _xdResult: function (a, b, c, d) {
                            return M._xdNextHandler(function (b) {
                                a && a(b.result && b.result != M._resultToken && ES("JSON", "parse", !1, b.result))
                            }, b, c, d) + "&result=" + encodeURIComponent(M._resultToken)
                        },
                        xdHandler: function (a, b, c, d, e, f) {
                            return M._xdNextHandler(o.xdResponseWrapper(a, d, e), b, c, f)
                        }
                    };
                    t.stub("showDialog");
                    A.stub("showDialog");
                ...
                __d("sdk.Canvas.IframeHandling", ["DOMWrapper", "sdk.RPC"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    function a(a, b) {
                        b === void 0 && typeof a === "number" && (b = a, a = !0), a || a === void 0 ? (i === null && (i = setInterval(function () {
                            l()
                ...
                __d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.fbt", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = function () {
                        __p && __p();
                ...
                __d("legacy:fb.init", ["FB", "sdk.Event", "sdk.init"], (function (a, b, c, d, e, f, g, h, i) {
                    "use strict";
                    g.provide("", {
                        init: i
                        ...
                        __buffer && __buffer.opts && i(__buffer.opts)
                    }, 0)
                }), 3);
                ...
                __d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j) {
                    ...
                    if (l) {
                        ...
                        if (b.length > 1) b = null;
                            ...
                            c = document.getElementById("facebook-jssdk-iframe");
                            c && c instanceof HTMLIFrameElement && (a = c.contentWindow.performance.getEntriesByType("resource").find(function (a) {
                                return ES(a.name, "startsWith", !0, o)
                            }));
                            b = b[0]
                        } else b = null;
                        b && (n.fetchTime = Math.round(b.duration), a && (n.fetchTime += Math.round(a.duration)), "transferSize" in b && (n.transferSize = b.transferSize, a && (n.transferSize += a.transferSize)), g.debug("sdkperf: it took %s ms and %s bytes to load %s", n.fetchTime, n.transferSize, o), m = b.startTime, n.ns = j.getSDKNS(), m && window.setTimeout(function () {
                            var a = h("log_perf", !1),
                                b = j.getSDKAB();
                            b && (n.ab = b, a = !0);
                            a && i.log(116, n)
                ...
                __d("XFBML", ["Assert", "Log", "ObservableMixin", "runOnce"], (function (a, b, c, d, e, f, g, h, i, j) {
                    __p && __p();
                    var k = {},
                        l = {},
                        m = 0,
                    ...
                    function q(a) {
                        return k[o(a, "nodeName").toLowerCase()] || k[p(a).toLowerCase()]
                    }

                    function r(a) {
                        var b = ES(o(a, "className").split(/\s+/), "filter", !0, function (a) {
                            return Object.prototype.hasOwnProperty.call(l, a)
                        });
                        if (b.length === 0) return void 0;
                        if (a.getAttribute("fb-xfbml-state") || !a.childNodes || a.childNodes.length === 0 || a.childNodes.length === 1 && a.childNodes[0].nodeType === 3 || a.children.length === 1 && o(a.children[0], "className") === "fb-xfbml-parse-ignore") return l[b[0]]
                    }
                    ...
                    function t(a, b, c) {
                        ...
                        var e = 1,
                            f = 0,
                            i = function () {
                                e--, e === 0 && (h.info("XFBML Parsing Finish %s, %s tags found", d, f), b(), n.inform("render", d, f)), g.isTrue(e >= 0, "onrender() has been called too many times")
                            };
                        ES(ES("Array", "from", !1, a.getElementsByTagName("*")), "forEach", !0, function (a) {
                            ...
                            b = function b() {
                                a.getAttribute("fb-xfbml-state") == "parsed" ? n.subscribe("render.queue", b) : (a.setAttribute("fb-xfbml-state", "parsed"), d.process())
                            };
                            b()
                        });
                        n.inform("parse", d, f);
                ...
                __d("sdk.XFBML.Comments", ["IframePlugin", "QueryString", "UrlMap", "sdk.DOM", "sdk.Event", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    var o = 320,
                        p = ES("Object", "assign", !1, {
                            numposts: "string",
                            href: "url",
                            permalink: "bool",
                            order_by: "string",
                    ...
                    function q(a, b) {
                        ...
                        if (!b.href) {
                            ...
                            if (!b.xid) {
                                ...
                                c > 0 ? b.xid = encodeURIComponent(document.URL.substring(0, c)) : b.xid = encodeURIComponent(document.URL)
                            }
                            b.migrated && (b.href = i.resolve("www") + "/plugins/comments_v1.php?app_id=" + l.getClientID() + "&xid=" + encodeURIComponent(b.xid) + "&url=" + encodeURIComponent(b.url))
                        } else {
                            c = b.fb_comment_id;
                            c || (c = h.decode(document.URL.substring(ES(document.URL, "indexOf", !0, "?") + 1)).fb_comment_id, c && ES(c, "indexOf", !0, "#") > 0 && (c = c.substring(0, ES(c, "indexOf", !0, "#"))));
                            c && (b.fb_comment_id = c)
                        }
                        b.version || (b.version = l.getVersion());
                        b.permalink || (b.width = b.mobile || b.width === "auto" || b.width === "100%" ? "" : b.width ? Math.max(b.width, o) : 550, b.height = 100);
                        if (b.href != null) {
                            c = new n(b.href);
                    ...
                    a = g.extend({
                        constructor: function (a, b, c, d) {
                            d = q(a, d), this.parent(a, b, c, d), this.subscribe("xd.sdk_event", function (a) {
                ...
                __d("sdk.XFBML.CommentsCount", ["sdk.DOM", "sdk.XFBML.Comments", "sprintf"], (function (a, b, c, d, e, f, g, h, i) {
                    a = h.extend({
                        constructor: function (a, b, c, d) {
                            g.addCss(a, "fb_comments_count_zero"), d.count = 1, this.parent(a, b, "comments", d), this.subscribe("xd.comment_count", function (b) {
                                b = ES("JSON", "parse", !1, b.data);
                                g.html(a, i('<span class="fb_comments_count">%s</span>', b.count));
                                b.count > 0 && g.removeCss(a, "fb_comments_count_zero");
                                g.removeCss(a, "fb_iframe_widget")
                            })
                        }
                    });
                    e.exports = a
                ...
                __d("sdk.XFBML.CustomerChat", ["IframePlugin", "Log", "QueryString", "getDocumentScrollElement", "sdk.Content", "sdk.createIframe", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.DOM", "sdk.DOMEventListener", "sdk.Event", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    "use strict";
                    __p && __p();
                    var v = ["animationend", "mozAnimationEnd", "MSAnimationEnd", "oAnimationEnd", "webkitAnimationEnd"],
                        w = null,
                        x = !(t.ie() <= 9),
                        y = null,
                        z = !1,
                    ...
                    a = g.extend({
                        ...
                        _setUpSubscriptions: function () {
                            ...
                            this.subscribe("xd.liveChatPluginGetBubbleIframe", ES(function (a) {
                                ...
                                C = ES("JSON", "parse", !1, a.passesMobileRedesignGK), ES("JSON", "parse", !1, a.isMobile) ? this._handlePrepareMobileAnchorIframe(a) : this._handlePrepareDesktopAnchorIframe(a)
                            ...
                            }, "bind", !0, this)), t.iphone() && (this.subscribe("xd.liveChatPluginFocusComposer", ES(function (a) {
                        ...
                        _handleGetBubbleIframe: function (a) {
                            this._bubbleDialog = this._setupNewIframeDialog(a.fromIframe), y = this._bubbleDialog, k.append(this._bubbleDialog), this.subscribe("xd.liveChatPluginShowBubbleIframe", ES(function (a) {
                                o.setStyle(this._bubbleDialog, "display", "inline"), x && (o.addCss(this._bubbleDialog, "fb_customer_chat_bubble_pop_in"), ES("JSON", "parse", !1, a.dialogHidden) || window.setTimeout(ES(function () {
                        ...
                        _handlePrepareDesktopAnchorIframe: function (a) {
                            this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"), ES("Object", "assign", !1, this._iframe.style, {
                                ...
                                width: "288pt",
                                zIndex: "2147483647"
                            }), o.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || x ? "0" : "100%"), ES("JSON", "parse", !1, a.chatStarted) && (z = !0, ES("Object", "assign", !1, this._iframe.style, {
                                height: "378pt"
                            })), A = this._iframe)
                        },
                        _handlePrepareMobileAnchorIframe: function (a) {
                            ...
                            if (this._iframe) {
                                ...
                                o.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || x ? "0" : "100%");
                                var b = ES("JSON", "parse", !1, a.chatStarted);
                                if (b) z = !0, ES("Object", "assign", !1, this._iframe.style, {
                                    boxShadow: "none",
                                    height: "100%",
                                    right: "0",
                                    top: "0",
                        ...
                        _handleResizeAnchorIframe: function (a) {
                            this._iframe && o.setStyle(this._iframe, "height", ES("JSON", "parse", !1, a.height) + "px")
                        },
                        _handleExpandDesktopDialogIframe: function () {
                            z = !0, this._iframe && o.setStyle(this._iframe, "height", "378pt")
                        },
                        _handleExpandMobileDialogIframe: function () {
                            z = !0, this._makeDialogIframeFullScreen(), H()
                        },
                        _handleShowDialogIframe: function (a) {
                            J(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile))
                        },
                        _handleHideDialogIframe: function (a) {
                            K(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile))
                        },
                        _handleShowInterstitialOnPage: function (a) {
                            !ES("JSON", "parse", !1, a.dialogHidden) ? (K(this._iframe, !1, !0, !1), window.setTimeout(ES(function () {
                                this._makeDialogIframeFullScreen(), F = !0, J(this._iframe, !1, !0, !0), H()
                            }, "bind", !0, this), 500)) : (this._makeDialogIframeFullScreen(), F = !0, J(this._iframe, !1, !0, !0))
                        },
                        _handleShadowUpdate: function (a) {
                            ES("JSON", "parse", !1, a.resetShadow) && this._bubbleDialog ? (o.setStyle(this._bubbleDialog, "borderRadius", "50%"), x ? o.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge") : o.setStyle(this._bubbleDialog, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)")) : ES("JSON", "parse", !1, a.resetShadow) || this._setBubbleBadgeStyle()
                        },
                        _handleUpdatePageTitle: function (a) {
                            !w && a.titleText ? (w = n.blink(a.titleText), p.add(window, "focus", ES(function (a) {
                                this._stopBlinking()
                            }, "bind", !0, this))) : w && !a.titleText && this._stopBlinking()
                        },
                        _handleFocusComposer: function () {
                            window.setTimeout(ES(function () {
                                var a = j();
                                a && (o.setStyle(this._iframe, "maxHeight", a.scrollHeight - a.scrollTop + "px"), a.scrollTo(0, 0))
                            }, "bind", !0, this), 700)
                        },
                        ...
                        _setupNewIframeDialog: function (a) {
                            ...
                            x ? (o.removeCss(b.dialogElement, "fb_customer_chat_bubble_animated_with_badge"), o.addCss(b.dialogElement, "fb_customer_chat_bubble_animated_no_badge")) : o.setStyle(b.dialogElement, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)");
                            return b.dialogElement
                        },
                        _setBubbleBadgeStyle: function () {
                            this._bubbleDialog && (o.setStyle(this._bubbleDialog, "borderRadius", "50% 0% 50% 50%"), x ? (o.removeCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge"), o.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_with_badge")) : o.setStyle(this._bubbleDialog, "boxShadow", "-5px 4px 14px rgba(0, 0, 0, 0.15)"))
                        },
                        _stopBlinking: function () {
                            w && (w.stop(), w = null)
                        },
                        _makeDialogIframeFullScreen: function () {
                            this._iframe && (o.setStyle(this._iframe, "boxShadow", "none"), o.setStyle(this._iframe, "border-radius", "0"), o.setStyle(this._iframe, "height", "100%"), o.setStyle(this._iframe, "right", "0"), o.setStyle(this._iframe, "top", "0"), o.setStyle(this._iframe, "width", "100%"))
                        },
                        getParams: function () {
                            return {
                                attribution: "string",
                    ...
                    function H() {
                        D = window.pageXOffset !== void 0 ? window.pageXOffset : document.documentElement && document.documentElement.scrollLeft, E = window.pageYOffset !== void 0 ? window.pageYOffset : document.documentElement && document.documentElement.scrollTop, o.addCss(document.body, "fb_mobile_overlay_active")
                    }

                    function I() {
                        o.removeCss(document.body, "fb_mobile_overlay_active"), window.scrollTo(D, E)
                    }
                    ...
                    function J(a, b, c, d) {
                        ...
                        if (G === null || G === !1) {
                            c && (b || C && F) && H();
                            if (x) {
                                c && (b || C && F) ? (c = "fb_customer_chat_bounce_in_v2_mobile_chat_started", b = "fb_customer_chat_bounce_out_v2_mobile_chat_started") : (c = "fb_customer_chat_bounce_in_v2", b = "fb_customer_chat_bounce_out_v2");
                                o.removeCss(a, b);
                                o.addCss(a, c)
                            }
                    ...
                    function K(a, b, c, d) {
                        ...
                        if (G === null || G === !0) {
                            ...
                            if (!x) o.setStyle(e, "maxHeight", "0");
                                ...
                                var f = function a(d) {
                                        var f;
                                        c && (b || C && F) ? f = "fb_bounce_out_v2_mobile_chat_started" : f = "fb_bounce_out_v2";
                                        d.animationName === f && (o.setStyle(e, "maxHeight", "0"), ES(v, "forEach", !0, function (b) {
                                            p.remove(e, b, a)
                                        }))
                                    },
                                    g;
                                c && (b || C && F) ? (a = "fb_customer_chat_bounce_in_v2_mobile_chat_started", g = "fb_customer_chat_bounce_out_v2_mobile_chat_started") : (a = "fb_customer_chat_bounce_in_v2", g = "fb_customer_chat_bounce_out_v2");
                                o.removeCss(e, a);
                                o.addCss(e, g);
                                ES(v, "forEach", !0, function (a) {
                                    p.add(e, a, f)
                                })
                            }
                            u.sendToFacebook(B, {
                    ...
                    a.show = function (a) {
                        a === void 0 && (a = !0), o.setStyle(y, "display", "inline"), a && J(A, z, t.mobile(), !1), q.fire("customerchat.show")
                    };
                    a.hide = function () {
                        o.setStyle(y, "display", "none"), K(A, z, t.mobile(), !1), q.fire("customerchat.hide")
                    };
                ...
                __d("sdk.XFBML.LoginButton", ["IframePlugin", "Log", "safeEval", "sdk.ErrorHandling", "sdk.feature", "sdk.Runtime", "sdk.Scribe", "sdk.ui", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    __p && __p();
                    var p = k("https_only_enforce_starting", !1),
                        q = k("https_only_learn_more", "");

                    function r(a, b, c) {
                        a && (typeof a === "string" ? j.unguard(i)(a, c) : a.apply && j.unguard(a).apply(b, c || []))
                    }
                    a = g.extend({
                        constructor: function (a, b, c, d) {
                            __p && __p();
                            if (location.protocol !== "https:" && p) {
                                var e = "The Login Button plugin will soon stop working on http pages. Please update your site to use https for Facebook Login. %s";
                                h.log("error", -1, e, q);
                                k("https_only_scribe_logging", !0) && m.log("jssdk_error", {
                                    appId: l.getClientID(),
                                    error: "HttpsOnly",
                                    extra: {
                                        message: "LoginButton"
                            ...
                            f && (i = function (a) {
                                ...
                                r(f, null, [a])
                            }, this.subscribe("login.status", i));
                            this.subscribe("xd.login_button_dialog_open", function (a) {
                                n(ES("JSON", "parse", !1, a.params), function (a) {
                                    r(i, null, [a]), o.sendToFacebook(j, {
                                        method: "loginReload",
                                        params: ES("JSON", "stringify", !1, a)
                                    })
                                })
                ...
                __d("sdk.XFBML.Video", ["Assert", "IframePlugin", "ObservableMixin", "sdk.Event", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    m.prototype.subscribe = function (a, b) {
                        "use strict";
                        g.isString(a, "Invalid argument");
                        g.isFunction(b, "Invalid argument");
                        this.$2.subscribe(a, b);
                        return {
                            release: ES(function () {
                                this.$2.unsubscribe(a, b)
                            }, "bind", !0, this)
                        }
                    };
                    a = h.extend({
                ...
                __d("legacy:fb.xfbml.plugins", ["IframePlugin", "PluginConfig", "PluginTags", "XFBML", "sdk.feature", "sdk.XFBML.CustomerChat", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.LoginButton", "sdk.XFBML.Quote", "sdk.XFBML.Save", "sdk.XFBML.ShareButton", "sdk.XFBML.Video"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    var l = {
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4658916","namespace":"FB","message":"' + e.message + '"}}');
}