/**
 * Created by anhvt on 13/01/2017.
 */
/**
    ...
    render () {
        return (
            <ComposedChart layout="vertical" width={1200} height={400} data={this.state.data}
                ...
                <YAxis dataKey="name" type="category" allowDataOverflow={false} tickSize={100} tickLine={false} minTickGap={14} tick={true} tickCount={3} />

                <Tooltip labelStyle="vc"/>
                {/*<Legend/>*/}
