...
import { fetchTotalPlayview } from './_Action';

class TotalPlayview extends React.Component{
    ...
    dataSource(props){
        ...
        this.props.fetchTotalPlayview(props.sourceMedia, beginDate, endDate);
    }
...
function mapStateToProps(state) {
  return { data: state.totals.total_playview };
}

export default connect(mapStateToProps, { fetchTotalPlayview })(TotalPlayview);
