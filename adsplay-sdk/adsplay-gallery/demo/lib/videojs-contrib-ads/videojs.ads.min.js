...
a.play()}}},"ads-ready?":{enter:function(){a.el().className+=" vjs-ad-loading";a.ads.timeout=e.setTimeout(function(){a.trigger("adtimeout")},d.timeout)},leave:function(){e.clearTimeout(a.ads.timeout);k(a.el(),"vjs-ad-loading")},events:{play:function(){h(a)},adsready:function(){this.state="preroll?"},adtimeout:function(){this.state="ad-timeout-playback"}}},"ad-timeout-playback":{events:{adsready:function(){a.paused()?this.state="display-ad-test-ready":this.state="preroll?"},contentupdate:function(){a.paused()?
this.state="content-set":this.state="display-ad-test-ready?"}}},"ad-playback":{enter:function(){var b=a.el().querySelector(".vjs-tech"),c={src:a.currentSrc(),currentTime:a.currentTime(),type:a.currentType()};b&&(c.nativePoster=b.poster);this.snapshot=c;l(a)},leave:function(){k(a.el(),"vjs-ad-playing");t(a,this.snapshot)},events:{adend:function(){this.state="content-playback"}}},"content-playback":{events:{adstart:function(){this.state="ad-playback";a.el().className+=" vjs-ad-playing";l(a)},contentupdate:function(){a.paused()?
this.state="content-set":this.state="display-ad-test-ready?"}}}};(function(f){var e=function(){};(g[f].events[b.type]||e).apply(a.ads);f!==a.ads.state&&((g[f].leave||e).apply(a.ads),(g[a.ads.state].enter||e).apply(a.ads),d.debug&&videojs.log("ads",f+" -> "+a.ads.state))})(a.ads.state)};r(a,m.Html5.Events.concat(["adtimeout","contentupdate","adsready","adstart","adend"]),b);a.ads.contentSrc=a.currentSrc();(function(){var b=function(){var b;"ad-playback"!==a.ads.state&&(b=a.currentSrc(),b!==a.ads.contentSrc&&(a.trigger({type:"contentupdate",
