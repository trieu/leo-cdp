<!-- Bootstrap modal -->
<div class="modal fade" id="modal_form_Publisher" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Publishers Form</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="formPublisher" class="form-horizontal" novalidate>
            ...
            <div class="modal-footer">
                <button type="submit" id="btnSave" onclick="save('Publisher')" class="btn btn-primary">Save</button>
